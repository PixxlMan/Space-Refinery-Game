...
namespace Space_Refinery_Game
{
    ...
    public static class Physics
    {
        ...
        public static void Run(MainGame game)
        {
            ...
            var sphereInertia = sphere.ComputeInertia(100);
            BodyHandle sphereHandle = simulation.Bodies.Add(BodyDescription.CreateDynamic(new Vector3(0, 20, 0), sphereInertia, simulation.Shapes.Add(sphere), 0.01f));
